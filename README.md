...
当前阶段不直接进入正文写作。P0 假设登记和 P1 L0 样本池已经完成初版，下一步先补 P0.5 合规与相似风险边界，再做 P2/L1：从 30 本候选样本中筛 10-15 本做前 10 章快拆。

## 当前主线

当前不继续补方法论，先按总控路线做 P0.5 和 P2/L1：

1. 先定义合规与相似风险边界。
2. 从 L0 的 30 本样本中筛 10-15 本。
3. 逐本做前 10 章快拆。
4. 记录读者承诺、章节运动、叙事因果、阻力反咬、翻牌和迁移边界。
...
3. 下一步先执行 P0.5：合规与相似风险边界。
4. 再进入 P2/L1：10-15 本前 10 章快拆。
